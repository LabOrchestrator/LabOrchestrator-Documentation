...
The web interface offers all the functionalities of the library and therefore also fulfills all the objectives.
...
We need to make a frondend that integrates the API, LabVNC and instructions. These frondend needs to implement the instruction goals. Also taking a look at why the clipboard in noVNC doesn't work would be good.
